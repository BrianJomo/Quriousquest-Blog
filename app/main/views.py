...
def index():
    ...
    if request.method == "POST":
        ...
        db.session.commit()
        welcome_message("Thank you for subscribing to Quriousquest Blog", "email/welcome", new_sub.email)
...
def subscribe():
    ...
    notification_message("Subscribed to Quriousquest Blog","email/welcome",new_sub.email,new_sub=new_sub)
